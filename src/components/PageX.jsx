...
const PageX = () => {
  ...
  const handleSubmit = async () => {
    await updateProgress((prevProgress) => prevProgress + 10);
    navigate('/PageU'); // Change to the appropriate next page route
  };
    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="card w-[600px] h-[500px] shadow-md p-1 border-2 bg-gray-200 flex flex-col">
        ...
        <div className="card w-[560px] mx-auto h-[300px] shadow-md p-4 border-2 border-gray-500 bg-gray-200 flex flex-col items-left mt-1">
          <p className="text-lg font-semibold">With regards to BMSs, are you:</p>
              ...
              <form onSubmit={handleSubmit} className="text-left mt-4">
                <div className="mb-4">
                  <label className="flex items-left">
                    ...
                    />
                    <span className="ml-2">Standardized on one BMS solution across sites</span>
                  </label>
                  ...
                  <label className="flex items-center mt-2">
                    <input
                      ...
                      onChange={handleNewIndustryChange}
                    />
                    <span className="mt-2 ml-2"> Use multiple vendors/generations of BMS solutions across sites and/or within single sites</span>
                  </label>
                  ...
                  <label className="flex items-center mt-8">
                    <input
                      ...
                      onChange={handleNewIndustryChange}
                    />
                    <span className="ml-2 mb-2">Please name which BMS(s) you use and explain whether they are on-premise, in the cloud or hybrid</span>
                  </label>
                  <input
                    type="text"
